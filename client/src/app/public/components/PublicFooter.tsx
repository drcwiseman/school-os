...
export const PublicFooter: React.FC = () => (
  <footer className="mkt-footer">
    <div className="mx-auto max-w-7xl section-pad !pb-10 !pt-14">
      <div className="grid gap-12 md:grid-cols-12">
        <div className="md:col-span-5">
          <Link to="/" className="inline-flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-marketing-sage/20">
              <GraduationCap className="h-5 w-5 text-marketing-sage" />
            </div>
            <span className="font-display text-xl font-semibold text-white">SchoolOS</span>
          </Link>
          <p className="mt-5 max-w-sm text-sm leading-relaxed text-marketing-cream/60">
        ...
        <div className="md:col-span-3">
          <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-marketing-sage">Product</p>
          <ul className="mt-5 space-y-3 text-sm text-marketing-cream/75">
        ...
        <div className="md:col-span-4">
          <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-marketing-sage">Sign in</p>
          <ul className="mt-5 space-y-3 text-sm text-marketing-cream/75">
      ...
      <div className="mt-14 flex flex-col gap-3 border-t border-white/10 pt-8 text-xs text-marketing-cream/40 md:flex-row md:items-center md:justify-between">
