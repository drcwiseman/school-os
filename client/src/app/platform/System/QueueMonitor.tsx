...
export const QueueMonitor: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-bold text-white">Worker queue monitor</h2>
...
function Card({ label, value, accent }: { label: string; value: string | number; accent?: string }) {
  const color = accent === "rose" ? "text-rose-400" : accent === "amber" ? "text-amber-400" : accent === "blue" ? "text-blue-400" : "text-white";
  return (
